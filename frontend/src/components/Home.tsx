        ...
        <div className="relative z-10 min-h-screen flex flex-col">
          ...
          <div className="flex-1 flex items-center justify-center px-4 sm:px-6">
            <div className="text-center w-full max-w-4xl">
              <h1 className="text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-black text-white tracking-tight mb-4 sm:mb-6">
                CDL<span className="text-red-500">YTICS</span>
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-gray-300 uppercase tracking-widest mb-6 sm:mb-8 px-4">
          ...
          <div className="py-12 sm:py-16 md:py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 text-center">
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 sm:mb-2">12</div>
                  <div className="text-gray-400 text-xs sm:text-sm uppercase tracking-widest">CDL TEAMS</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 sm:mb-2">48</div>
                  <div className="text-gray-400 text-xs sm:text-sm uppercase tracking-widest">ACTIVE PLAYERS</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 sm:mb-2">5</div>
                  <div className="text-gray-400 text-xs sm:text-sm uppercase tracking-widest">MAJOR EVENTS</div>
                </div>
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-white mb-1 sm:mb-2">24/7</div>
                  <div className="text-gray-400 text-xs sm:text-sm uppercase tracking-widest">LIVE UPDATES</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="py-12 sm:py-16 md:py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8">
                <div className="bg-black bg-opacity-50 backdrop-blur-sm border border-gray-800 p-6 sm:p-8 hover:border-white transition-all duration-300">
