...
# OAC: allows CloudFront to read S3 without making the bucket public
...
resource "aws_cloudfront_distribution" "main" {
  ...
  # Origin 1: S3 bucket (serves the Svelte frontend)
  origin {
  ...
  # SPA catch-all: 403/404 from S3 → return index.html so React Router / SvelteKit routing works
