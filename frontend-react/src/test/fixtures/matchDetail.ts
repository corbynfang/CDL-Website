...
function makePlayerStat(
  overrides: Partial<PlayerStat> & { player_id: number; gamertag: string },
): PlayerStat {
  return {
    kills: 20,
    deaths: 15,
...
export const shotzzy = makePlayerStat({
  player_id: 1,
  gamertag: "Shotzzy",
  kills: 24,
  deaths: 14,
...
export const cellium = makePlayerStat({
  player_id: 2,
  gamertag: "Cellium",
  kills: 18,
  deaths: 16,
  ...
  maps: [
    {
      ...
      played: true,
      team1_stats: [
        makePlayerStat({ player_id: 1, gamertag: "Shotzzy", damage: 0 }),
      ],
      team2_stats: [
        makePlayerStat({ player_id: 2, gamertag: "Cellium", damage: 0 }),
      ],
    },
  ],
};
