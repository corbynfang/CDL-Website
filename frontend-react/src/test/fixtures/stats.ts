...
function makeStat(
  overrides: Partial<PlayerTournamentStats> & { id: number; player_id: number },
  ...
  return {
    ...
    player: {
      ...
      gamertag: `Player${overrides.player_id}`,
      is_active: true,
      created_at: "",
      updated_at: "",
    },
...
export const highKDStat = makeStat({
  id: 1,
  player_id: 1,
  kd_ratio: 1.45,
  total_kills: 120,
...
export const lowKDStat = makeStat({
  id: 2,
  player_id: 2,
  kd_ratio: 0.88,
  total_kills: 70,
...
export const noPlayerStat = makeStat({
  id: 3,
  player_id: 99,
  kd_ratio: 1.1,
  player: undefined,
