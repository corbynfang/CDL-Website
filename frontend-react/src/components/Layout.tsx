...
const Layout = () => {
	...
	const { session, openAuthModal, closeAuthModal, showAuthModal, needsProfileSetup, signOut } = useAuth();
	...
	return (
		<div className="min-h-screen bg-[#0a0a0a] text-[#f5f5f5]">
			...
			{(showAuthModal || needsProfileSetup) && <AuthModal onClose={closeAuthModal} />}
