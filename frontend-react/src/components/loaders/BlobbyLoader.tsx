...
export default function BlobbyLoader({ label = 'Loading...', color = '#78BE20' }: BlobbyLoaderProps) {
  return (
      ...
      <div className="relative w-20 h-20">
        <div
          ...
          style={{
            ...
            animation: 'blob-morph 4s ease-in-out infinite, blob-pulse 2s ease-in-out infinite',
